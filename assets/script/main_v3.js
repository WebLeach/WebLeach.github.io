...
class Datas {
	...
	async get_project_data(){
		...
		this.pages_list = data.pages_list;
	...
	async get_chapter_data(page_id){
		...
		this.images_loc = data.images_loc;
		this.current_page_index = data.current_page_index;
...
alt_script(["https://dcdn.jsdelivr.net/npm/hammerjs@2.0.8/hammer.min.js", "/assets/scripts/hammer.min.js"], "Hammer")
